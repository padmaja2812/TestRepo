//Form JS File
function addWidgetsfrmNoticies() {
    ...
    var FlexHeader = new kony.ui.FlexContainer({
        ...
        "clipBounds": true,
        "Location": "[0,0]",
        "skin": "CopyslFbox0521e8ebc113a41",
        "layoutType": kony.flex.FREE_FORM
    }, {
        "padding": [0, 0, 0, 0]
    }, {});;
    ...
    frmNoticies.add(
    FlexContainerMain, FlexContainerTrans, FlexHeader, FlexContainerHamburger);
    frmNoticies.preShow = frmNoticies_preShow_mobile;
    frmNoticies.onDeviceBack = frmNoticies_onDeviceBack_mobile;
    frmNoticies.CopybtnMenu && (frmNoticies.CopybtnMenu.onClick = frmNoticies_CopybtnMenu_onClick_mobile);
    frmNoticies.segMenu && (frmNoticies.segMenu.onRowClick = frmNoticies_segMenu_onRowClick_mobile);
    frmNoticies.FlexContainer049970384ee5846 && (frmNoticies.FlexContainer049970384ee5846.onTouchEnd = frmNoticies_FlexContainer049970384ee5846_onTouchEnd_mobile);
    frmNoticies.imgHeaderLogo && (frmNoticies.imgHeaderLogo.onTouchEnd = frmNoticies_imgHeaderLogo_onTouchEnd_mobile);
    frmNoticies.btnMenu && (frmNoticies.btnMenu.onClick = frmNoticies_btnMenu_onClick_mobile);
    frmNoticies.FlexContainerTrans && (frmNoticies.FlexContainerTrans.onTouchEnd = frmNoticies_FlexContainerTrans_onTouchEnd_mobile);
};

function frmNoticiesGlobals() {
    var MenuId = [];
    frmNoticies = new kony.ui.Form2({
        "id": "frmNoticies",
        "enableScrolling": true,
        "bounces": true,
        ...
        "layoutType": kony.flex.FREE_FORM,
        "addWidgets": addWidgetsfrmNoticies
    }, {
        "padding": [0, 0, 0, 0],
    ...
    frmNoticies.setDefaultUnit(kony.flex.DP);
};