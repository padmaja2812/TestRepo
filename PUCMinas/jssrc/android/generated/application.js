...
function appmiddlewareinvoker(inputParam, isBlocking, indicator, datasetID) {
    ...
    inputParam["platformver"] = "6.5.GA_v201508132100";
...
function callAppMenu() {
    ...
    kony.application.createAppMenu("PUCMinasAppMenu", appMenu, null, null);
    kony.application.setCurrentAppMenu("PUCMinasAppMenu");
}