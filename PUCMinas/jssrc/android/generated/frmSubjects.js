//Form JS File
function addWidgetsfrmSubjects() {
    ...
    var imgSubjectHeader = new kony.ui.Image2({
        "id": "imgSubjectHeader",
        "top": "0%",
        "left": "0%",
        "width": "100%",
    ...
    CopylblHeader0eb477a473d8d45);
    var SegSubjectsbox = new kony.ui.FlexContainer({
        "id": "SegSubjectsbox",
        "isVisible": true,
        "orientation": null,
        "width": "100%",
    ...
    var SegSubjects = new kony.ui.SegmentedUI2({
        "id": "SegSubjects",
        "top": "0%",
        "left": "0%",
        "width": "92%",
        ...
        "data": [{
            ...
            "lblSubjectName": "Cultura Religiosa Pessoa..."
        }, {
            "imgArrow": "rightarrow.png",
            "lblSubjectName": "Economia"
        }],
        "Location": "[18,0]",
        "rowTemplate": SegSubjectsbox,
    ...
    imgSubjectHeader, FlexContainer0555448ab99324e, FlexScrollContainerNews);
    ...
    frmSubjects.preShow = frmSubjects_preShow_mobile;
    frmSubjects.btnMenu && (frmSubjects.btnMenu.onClick = frmSubjects_btnMenu_onClick_mobile);
    frmSubjects.CopybtnMenu && (frmSubjects.CopybtnMenu.onClick = frmSubjects_CopybtnMenu_onClick_mobile);
    frmSubjects.segMenu && (frmSubjects.segMenu.onRowClick = frmSubjects_segMenu_onRowClick_mobile);
    frmSubjects.imgHeaderLogo && (frmSubjects.imgHeaderLogo.onTouchEnd = frmSubjects_imgHeaderLogo_onTouchEnd_mobile);
    frmSubjects.SegSubjects && (frmSubjects.SegSubjects.onRowClick = frmSubjects_SegSubjects_onRowClick_mobile);
    frmSubjects.FlexContainerTrans && (frmSubjects.FlexContainerTrans.onTouchEnd = frmSubjects_FlexContainerTrans_onTouchEnd_mobile);
};

function frmSubjectsGlobals() {
    var MenuId = [];
    frmSubjects = new kony.ui.Form2({
        "id": "frmSubjects",
        "enableScrolling": true,
        "bounces": true,
        ...
        "skin": "frmBg",
        "layoutType": kony.flex.FREE_FORM,
        "addWidgets": addWidgetsfrmSubjects
    }, {
        "padding": [0, 0, 0, 0],
    ...
    frmSubjects.setDefaultUnit(kony.flex.DP);
};