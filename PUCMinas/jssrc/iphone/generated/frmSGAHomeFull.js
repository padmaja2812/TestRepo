//Form JS File
function addWidgetsfrmSGAHomeFull() {
    ...
    frmSGAHomeFull.add(
    FlexContainerMain, FlexHeader);
    frmSGAHomeFull.btnBack && (frmSGAHomeFull.btnBack.onClick = frmSGAHomeFull_btnBack_onClick_mobile);
    frmSGAHomeFull.preShow = frmSGAHomeFull_preShow_mobile;
    frmSGAHomeFull.btnMenu && (frmSGAHomeFull.btnMenu.onClick = frmSGAHomeFull_btnMenu_onClick_mobile);
    frmSGAHomeFull.imgHeaderLogo && (frmSGAHomeFull.imgHeaderLogo.onTouchEnd = frmSGAHomeFull_imgHeaderLogo_onTouchEnd_mobile);
};

function frmSGAHomeFullGlobals() {
    var MenuId = [];
    frmSGAHomeFull = new kony.ui.Form2({
        "id": "frmSGAHomeFull",
        "enableScrolling": true,
        "bounces": true,
        ...
        "layoutType": kony.flex.FREE_FORM,
        "addWidgets": addWidgetsfrmSGAHomeFull
    }, {
        "padding": [0, 0, 0, 0],
    ...
    frmSGAHomeFull.setDefaultUnit(kony.flex.DP);
};